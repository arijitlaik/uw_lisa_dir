...
outputDirName = "3d_2wlR8_DenLim_bNuLc_wLC_VutUc_thDc_eta0_1e3_Lc1e3_nlLM_2dot5e15_sLc"
...
aRatioMesh = [2, 1]  # xRes/yRes,zRes/yRes
...
# )
slabshapes = make_slab2d(
    topX=nd(0.725 * modelHeight)-nd(0.3 * modelHeight),
    topY=0.0,
    length=nd(1.275 * modelHeight)+nd(0.3 * modelHeight),
    taper=18,
    dip=29,
    depth=nd(120.0 * u.kilometer),
    thicknessArray=[
...
slabWidth = fn.coord()[2] <= nd(2.*modelHeight)
...
indentorWidth = (fn.coord()[2] <= nd(0.85*modelHeight))
...
if restartFlag is False:
    checkpoint(
        ...
        swarm,
        {"materialsInit": materialVariable},
        index=0,
