...
outputDirName = "/Users/arijit/Documents/research/lisa1/uw/r8_interfaceTest/R8_utUc_eta0_1e3_Lc1e3_nlLM_1e15_sLc"
...
plt.plot(dm(time[1:, 1], u.megayear), dm(vsp, u.centimeter / u.year), label="$V_s$2")
plt.legend()
