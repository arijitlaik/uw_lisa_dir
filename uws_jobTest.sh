...
srun -n 24 singularity exec --pwd $PWD underworld2-dev.simg  python iea2D-v0.0.8_ul.py
# srun -n 24 singularity exec --pwd $PWD underworld2-2.5.1b_magnus.simg  python iea2D-v0.0.8_ul.py
#
