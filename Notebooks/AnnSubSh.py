...
store = None
fig = glucifer.Figure(store=store, figsize=(1200, 800))
# fig.append( glucifer.objects.Mesh( mesh ,nodeNumbers=True))
fig.append(glucifer.objects.Mesh(mesh))
# fig.append( glucifer.objects.Points( swarm,pointsize=3))
fig.show()
...
figV = glucifer.Figure(store=store, figsize=(1200, 800))
...
fig = glucifer.Figure(store=store, figsize=(1200, 800))
fig.append(glucifer.objects.Mesh(mesh))
fig.append(glucifer.objects.Points(swarm, materialVariable, pointsize=3))
...
slabYieldvisc = fn.exception.SafeMaths(fn.misc.min(vonMises, 100))
viscosityMap = {0: 1.0, 1: 100.0, 2: 1000.0, 3: slabYieldvisc}
...
store = None
figVisc = glucifer.Figure(store=store, figsize=(1200, 800))
figVisc.append(glucifer.objects.Points(swarm, viscosityFn, pointsize=3, logScale=True))
...
figDensity = glucifer.Figure(store=store, figsize=(1200, 800))
figDensity.append(glucifer.objects.Points(swarm, viscosityFn, pointsize=3))
